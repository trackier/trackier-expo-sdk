...
interface TrackierConfigProps {
  appToken: string;
  environment: string;
  secretId?: string;
  secretKey?: string;
  manualMode?: boolean;
  disableOrganicTrack?: boolean;
...
class TrackierEvent {
  ...
  static LEVEL_ACHIEVED = "1CFfUn3xEY";
  static ADD_TO_CART = "Fy4uC1_FlN";
  static ADD_TO_WISHLIST = "AOisVC76YG";
  static COMPLETE_REGISTRATION = "mEqP4aD8dU";
  static TUTORIAL_COMPLETION = "99VEGvXjN7";
  static PURCHASE = "Q4YsqBKnzZ";
  static SUBSCRIBE = "B4N_In4cIP";
  static START_TRIAL = "jYHcuyxWUW";
  static ACHIEVEMENT_UNLOCKED = "xTPvxWuNqm";
  static CONTENT_VIEW = "Jwzois1ays";
  static TRAVEL_BOOKING = "yP1-ipVtHV";
  static SHARE = "dxZXGG1qqL";
  static INVITE = "7lnE3OclNT";
  static LOGIN = "o91gt1Q0PK";
  static UPDATE = "sEQWVHGThl";
...
TrackierSDK.multiply = function (a: number, b: number): Promise<number> {
  return module_trackier.multiply(a, b);
}
